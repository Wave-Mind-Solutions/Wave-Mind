  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 z-20 font-sans">
      ...
      <form 
        ...
        className={`relative rounded-[24px] transition-all duration-300 backdrop-blur-2xl bg-white/80 dark:bg-[#0b081c]/90 border ${
          isFocused 
            ? 'border-blue-500/70 dark:border-purple-500/70 shadow-[0_0_35px_rgba(59,130,246,0.25)] dark:shadow-[0_0_35px_rgba(168,85,247,0.3)] ring-1 ring-blue-500/40 dark:ring-purple-500/40' 
            : 'border-gray-200/80 dark:border-purple-500/25 shadow-lg dark:shadow-[0_10px_35px_rgba(0,0,0,0.5)] hover:border-blue-500/40 dark:hover:border-purple-500/45'
        } p-3 sm:p-3.5`}
      >
        {/* Previews Bar */}
        <AnimatePresence>
          {(attachedFiles.length > 0 || imagePreview) && (
            <motion.div 
              ...
              className="flex flex-wrap items-center gap-2.5 px-2 pt-1 pb-2.5 border-b border-gray-200/60 dark:border-purple-500/15 mb-2.5"
            >
              {imagePreview && (
                <div className="relative group rounded-xl overflow-hidden border border-gray-200 dark:border-purple-500/40 w-14 h-14 bg-black/40">
              ...
              {attachedFiles.map((f, i) => (
                <div 
                  key={i} 
                  className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-blue-50 dark:bg-purple-500/15 border border-blue-200 dark:border-purple-500/30 text-xs font-medium text-blue-700 dark:text-purple-200"
                >
                  <FileText className="w-4 h-4 shrink-0 text-blue-500 dark:text-purple-400" />
        ...
        <div className="flex items-center gap-3 min-h-[48px] sm:min-h-[52px]">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <button
              ...
              className="w-10 h-10 rounded-xl flex items-center justify-center text-gray-500 dark:text-purple-300/70 hover:text-gray-900 dark:hover:text-purple-200 hover:bg-gray-100 dark:hover:bg-purple-500/15 transition-all"
            >
            ...
            <button
              ...
              title="Upload Image"
              className="w-10 h-10 rounded-xl flex items-center justify-center text-gray-500 dark:text-purple-300/70 hover:text-gray-900 dark:hover:text-purple-200 hover:bg-gray-100 dark:hover:bg-purple-500/15 transition-all hidden sm:flex"
            >
          ...
          <textarea
            ...
            className="w-full bg-transparent text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-purple-300/40 text-base sm:text-lg px-2 py-1.5 outline-none resize-none min-h-[40px] max-h-[180px] leading-relaxed font-sans"
          />
