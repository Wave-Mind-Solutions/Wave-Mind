...
const Navbar = memo(() => {
  ...
  // Passive scroll listener — doesn't block scroll gesture
  useEffect(() => {
            ...
            <div className="flex items-center gap-4">
              ...
              {user ? (
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-3 w-56 bg-white/90 dark:bg-[#0a0c14]/90 backdrop-blur-2xl rounded-2xl shadow-2xl border border-gray-200 dark:border-white/10 overflow-hidden z-[100] opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-200">
