...
const projects = [
  {
    ...
    liveLink: "https://pathfinder-ai-beb6d1d0-main.vercel.app/",
    complexity: 88,
    features: [
...

  {
    ...
    liveLink: "https://pratyush-two.vercel.app",
    complexity: 90,
    features: [
  ...
  },
  {
    ...
    description: "VaultX is a full-stack password manager using client-side AES-256 encryption. Credentials are encrypted in the browser before being stored securely in Firebase.",
    tech: ["React", "Firebase", "CryptoJS", "AES-256"],
    link: "https://github.com/harshit-tripathi1001/VaultX",
    liveLink: "https://vaultx-manager.vercel.app/",
    complexity: 92,
    features: [
      "Client-side AES-256 encryption",
      "Firebase Authentication & Cloud Firestore",
      "Password generation & strength checking",
      "Search, categories, and profile management"
    ],
    impact: "Zero-Knowledge cloud credential storage",
    chartTitle: "Encryption Overhead (ms)",
    chartType: "bar",
    chartsData: [
      { label: "Standard Auth", val1: 15 },
      { label: "AES-256 Auth", val1: 45 }
    ],
    chartLegend: ["Latency (ms)"],
    architecture: "React frontend utilizing CryptoJS for client-side E2E encryption before storing ciphertext in Firebase Cloud Firestore."
  },
  {
    id: "codecupid",
    title: "CodeCupid",
    ...
    description: "CodeCupid is a campus-only developer matchmaking and innovation platform connecting students based on skills, validating project ideas, and recommending teams.",
    tech: ["React", "TypeScript", "Tailwind CSS", "Firebase", "Recharts"],
    link: "https://github.com/harshit-tripathi1001/CodeCupid",
    liveLink: "https://code-cupid.vercel.app/",
    complexity: 88,
    features: [
      "Skill-based developer matching",
      "AI-powered problem validation & team building",
      "Help Wanted project board",
      "Real-time chat & execution tracking"
    ],
    impact: "Accelerates campus innovation matchmaking",
    chartTitle: "Successful Team Formations",
    chartType: "area",
    chartsData: [
      { label: "Week 1", val1: 12, val2: 5 },
      { label: "Week 2", val1: 28, val2: 12 },
      { label: "Week 3", val1: 45, val2: 24 },
      { label: "Week 4", val1: 68, val2: 38 }
    ],
    chartLegend: ["Active Users", "Teams Formed"],
    architecture: "Vite + React frontend with TypeScript, styled using Tailwind CSS and Framer Motion, supported by a Firebase backend for real-time capabilities."
  },
  {
    id: "tradevista",
    title: "TradeVista",
    ...
    description: "TradeVista is a full-stack Zerodha-inspired trading platform featuring a professional landing page and dedicated portfolio trading dashboard experience.",
    tech: ["React", "Full-Stack Architecture", "Responsive UI"],
    link: "https://github.com/PratyushPandey31/tradevista-trading",
    liveLink: "https://pratyush-tradevista.vercel.app/",
    complexity: 85,
    features: [
      "Modern trading platform interface",
      "Dedicated landing page experience",
      "Portfolio-oriented dashboard",
      "Responsive full-stack web architecture"
    ],
    impact: "High-performance trading dashboard rendering",
    chartTitle: "Dashboard Render Time (ms)",
    chartType: "bar",
    chartsData: [
      { label: "Standard UI", val1: 850 },
      { label: "TradeVista", val1: 120 }
    ],
    chartLegend: ["Render Time (ms)"],
    architecture: "Full-stack application architecture focusing on financial/trading workflows, optimized for real-time dashboard rendering."
  },
  {
    id: "wanderlust",
    title: "WanderLust",
    ...
    description: "WanderLust is a full-stack Airbnb-inspired platform focused on property listings, booking workflows, and review management.",
    tech: ["React", "Full-Stack Architecture", "Responsive Web"],
    link: "https://github.com/PratyushPandey31/wanderLust",
    liveLink: "https://pratyush-wanderlust.vercel.app/listings",
    complexity: 80,
    features: [
      "Property listings exploration",
      "Booking management workflow",
      "Review and rating system",
      "Responsive listing interface"
    ],
    impact: "Streamlined property booking experience",
    chartTitle: "Booking Conversion Rate (%)",
    chartType: "area",
    chartsData: [
      { label: "Jan", val1: 2.5 },
      { label: "Feb", val1: 3.8 },
    ...
    chartLegend: ["Conversion Rate (%)"],
    architecture: "Full-stack web application designed for high-availability property listing searches and transactional booking workflows."
  }
];
                ...
                {filters.map((filter) => {
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-full px-5 py-2 text-xs font-bold transition-all duration-300 ${isActive
                ...
                <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-3 w-full mt-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex w-full sm:w-1/2 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-6 py-3.5 text-sm font-bold shadow-lg shadow-emerald-500/20 hover:scale-105 transition-all cursor-pointer"
                    >
                      Live Deployed
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex w-full sm:w-1/2 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3.5 text-sm font-bold shadow-lg shadow-blue-500/20 hover:scale-105 transition-all cursor-pointer"
                    >
                      Source Code
